...
class Nota < ApplicationRecord
    ...
    #ok
    def self.get_total_de_todas_notas_pelo_codigo_do_curso(codigo_do_curso)
    ...
    #ok
    def self.get_soma_das_notas_do_aluno_pelo_curso(matricula, codigo_do_curso)
